...
public class InnsynKontroller {
    ...
    public static final String KRAV_PATH = INNSYN_API_PATH + "/krav";
    ...
    @Autowired
    public InnsynKontroller(Kravregister kravregister, Forbipasseringsregister forbipasseringsregister) {
